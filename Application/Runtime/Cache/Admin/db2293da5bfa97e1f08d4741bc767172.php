...
<body>
    ...
    <div class="formbody">
    	<div class="formtitle"><span>新增图片</span></div>
	    <form action="<?php echo U('add');?>" method="post" class="layui-form">
	    	<input type="hidden" id="p_pic" name="p_pic" />
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label">图片名称</label>
					<div class="layui-input-inline"><input type="text" name="p_name" lay-verify="required" class="layui-input"></div>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
		    ...
		    <div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<script id="editor" name="p_detail" type="text/plain"></script>
