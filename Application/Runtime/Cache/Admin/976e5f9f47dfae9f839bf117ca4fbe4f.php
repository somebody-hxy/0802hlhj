...
<body>
    ...
    <div class="formbody">
	    ...
	    <form action="<?php echo U('edit');?>" method="post" class="layui-form">
	    	...
	    	<input type="hidden" name="vt_id" value="<?php echo ($list["vt_id"]); ?>">
	    	<!--<input type="hidden" id="vt_pic" name="vt_pic" value="<?php echo ($list["vt_pic"]); ?>" />-->
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label">分类名称</label>
					<div class="layui-input-inline"><input type="text" name="vt_name" value="<?php echo ($list["vt_name"]); ?>" lay-verify="required" class="layui-input"></div>
				</div>
			</div>
			<!--<div class="layui-form-item">
				<div class="layui-inline">
		    ...
		    <div class="layui-form-item">
		    	<div class="layui-inline">
		            ...
		            <div class="layui-input-inline"><img id="pic" src="<?php echo ($list["vt_pic"]); ?>" style="max-width: 320px;max-height: 200px;" /></div>
		        </div>
		    </div>-->
			<div class="layui-form-item">
